...
HD_PWD='C:/Users/mexic/Subtractor/Subtractor.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log N_Bit_Subtractor.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source N_Bit_Subtractor.tcl
