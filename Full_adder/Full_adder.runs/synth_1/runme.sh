...
HD_PWD='C:/Users/mexic/Full_adder/Full_adder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log EightBit_FA.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source EightBit_FA.tcl
