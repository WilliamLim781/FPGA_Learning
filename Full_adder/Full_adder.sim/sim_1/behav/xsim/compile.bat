...
REM
REM Generated by Vivado on Tue Dec 23 19:25:42 -0600 2025
...
echo "xvhdl --incr --relax -prj EightBit_FA_TB_vhdl.prj"
call xvhdl  --incr --relax -prj EightBit_FA_TB_vhdl.prj -log xvhdl.log
